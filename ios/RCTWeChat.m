    ...
    if ([type isEqualToString:RCTWXShareTypeText]) {
        ...
        if (type.length <= 0 || [type isEqualToString:RCTWXShareTypeNews]) {
            ...
            [self shareToWeixinWithMediaMessage:aScene
                   ...
                   [type isEqualToString:@"imageBase64"]
                   ) {
...
//
            ...
            NSString *base64 = aData[RCTWXShareImageUrl];
            ...
            float thumbScaleSize      = 200.0/_decodedImage.size.width;
            UIImage *_thumbImage      = [self scaleImage:_decodedImage toScale:thumbScaleSize];
            ...
            imageObject.imageData = UIImagePNGRepresentation(composeImage);
                    [self shareToWeixinWithMediaMessage:aScene
                                                  Title:title
                                            Description:description
                                                 Object:imageObject
...
//            }];
            ...
            [self shareToWeixinWithMiniProgramTitle:title
                                        Description:description
                                         ThumbImage:aThumbImage
                                               path:path
                                           callBack:callback];
...
- (void)shareToWeixinWithMiniProgramTitle:(NSString *)title
                              Description:(NSString *)description
                               ThumbImage:(UIImage *)thumbImage
                                     path:(NSString *)path
                                 callBack:(RCTResponseSenderBlock)callback
{
    ...
    wxMiniObject.userName = @"gh_70b0b7c85e65";
    wxMiniObject.path = path;
    wxMiniObject.hdImageData = UIImagePNGRepresentation(thumbImage);
