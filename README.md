...
```sh
$ yarn add @pangu/react-native-wechat
```
...
- Add following lines into `android/settings.gradle`
    ...
    ```gradle
    include ':@pangu/react-native-wechat'
    project(':@pangu/react-native-wechat').projectDir = new File(rootProject.projectDir, '../node_modules/@pangu/react-native-wechat/android')
    ```
...
- Add following lines into your `android/app/build.gradle` in section `dependencies`
    ...
    ```gradle
    dependencies {
      compile project(':@pangu/react-native-wechat')    // Add this line only.
    }
    ```
